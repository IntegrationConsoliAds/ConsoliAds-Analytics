...
Pod::Spec.new do |s|
  ...
  s.version          = '0.0.1'
  s.summary          = 'ConsoliAds-Analytics is a pod for download records.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  'ConsoliAds-Analytics is a pod for download records.'
                       DESC
...
#  s.source_files = 'ConsoliAds-Analytics/Classes/**/*'
...
s.static_framework = true
  # s.resource_bundles = {
  #   'ConsoliAds-Analytics' => ['ConsoliAds-Analytics/Assets/*.png']
  # }
